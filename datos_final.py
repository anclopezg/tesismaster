...
for posicion in range(len(list_VG1)):
    ...
    sql="insert into tabla_datafinal(V_G1, FR_G1, P_AT,EG1, V_G2, FR_G2, P_AT2, EG2, fecha) values (%s, %s, %s, %s, %s, %s,%s,%s, %s)"
...
conexion1.close()
conexion2=mysql.connector.connect(host="localhost", user="admin", passwd="Rita*1234", database="data1")
cursor2=conexion2.cursor()
Application2 = "instrumento-wind-ud"
APIKey2 = "NNSXS.5237MEEUB3WCMS5HY7IRF2I4QU4DRBVKASSZ5DA.QTTUEKBQFNJS5WWLXC4QGEIS4AAS32J4RTV6PIQRR37R2C3T4CAA"
Fields2 = "up.uplink_message.decoded_payload,up.uplink_message.frm_payload"
NumberOfRecords = 10
Fecha = "2021-08-20T00:00:00Z"
URL2 = "https://nam1.cloud.thethings.network/api/v3/as/applications/" + Application2 + "/packages/storage/uplink_message?order=-received_at&limit=" + str(NumberOfRecords) + "&field_mask=" + Fields2
Header2 = { "Accept": "text/event-stream", "Authorization": "Bearer " + APIKey2 }
print("\n\nFetching from data storage...\n")
...
for i in range(len(json2)):
    ...
    velW = envio['velW']
    fecha = envio["fecha"].replace("T"," ").replace("Z"," ")
    sql="insert into tabla_datafinal(velU,velV,velW, fecha) values (%s, %s, %s, %s)"
